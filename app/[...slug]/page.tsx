...
function PageNotFound({ path }: { path: string }) {
  return (
    <div className="text-center py-16">
      <div className="bg-white border-l-4 border-primary-600 shadow-sm p-12">
        <h1 className="text-2xl font-serif font-semibold text-gray-900 mb-4">Page Not Found</h1>
    ...
    return (
      <div className="min-h-screen bg-[#faf8f5]">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          <ErrorBoundary>
            <article className="bg-white border-l-4 border-primary-600 shadow-sm overflow-hidden">
              {image && (
                <ResponsiveImage
                  image={image}
                  alt={image.alt || title}
              ...
              <div className="p-6 md:p-8">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-medium text-gray-900 mb-4 md:mb-6">{title}</h1>
                <div className="w-24 h-0.5 bg-primary-600 mb-6" />
